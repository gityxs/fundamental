...
var cnItems = {
    ...
    "Allows to shift Cosmic dust and Solar mass hardcaps (in Rank settings). Extra levels allow for 2 times bigger shift.": "允许移动宇宙尘埃和太阳质量硬帽（在排名设置中）。 额外的水平允许 2 倍大的转变。",
    "Auto Stage.": "自动舞台。",
    "Automatic Collapse.": "自动折叠。",
    "Automatic Rank.": "自动排名。",
    "Automatic Vaporization.": "自动汽化。",
    "Automatically increase Rank when available.": "可用时自动增加排名。",
    ...
    "Some Rank researches receive extra Max level.\nFinal level will instead unlock a new upgrade.": "一些排名研究获得额外的最高等级。\n最终等级将解锁新的升级。",
