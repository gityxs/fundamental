...
var cnItems = {
    ...
    "Game is loading. If it won't load, then can try to report it": "游戏正在加载。 如果它不能正常加载，那么可以尝试报告它，点",
    "here": "这里",
    "Hide": "隐藏",
    ...
    "Drops will produce Moles even more for every self-made Drops.": "每次自制 Drops，Drops 都会产生更多的鼹鼠。",
    ...
    "Rivers can split now, that allows even more Ponds per Lake. (+1 per)": "河流现在可以分开，这允许每个湖有更多的池塘。 （+1 每）",
    "Seas get a boost based on amount of Clouds. (Equal to 5.25)": "海洋根据云的数量得到提升。 （等于 5.25）",
    "Some Clouds will start pouring Drops themselves. (1000 per second)": "一些 Clouds 会开始自己倾倒 Drops。 （每秒 1000 个）",
    "Storm Clouds.": "暴风云。",
