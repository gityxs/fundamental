...
var cnItems = {
    ...
    "Discharge bonus improved.": "出院奖金提高。",
    "Discharge goal requirements decreased.": "出院目标要求降低。",
    ...
    "Better Mole production.": "更好的鼹鼠生产。",
    "Clouds": "云",
    "Condensation.": "缩合。",
    "Drops": "水滴",
    "Drops produce 3 times more Moles.": "水滴产生 3 倍以上的鼹鼠。",
    "Drops will produce Moles even more for every self-made Drops.": "每次自制 水滴，水滴 都会产生更多的鼹鼠。",
    ...
    "Lakes": "湖泊",
    "Molecules to Moles. Even more Moles.": "分子到鼹鼠。 甚至更多的鼹鼠。",
    "Moles": "鼹鼠",
    "More streams.": "更多流。",
    "Ponds": "池塘",
    ...
    "Biggest of all.": "最大的。",
    "Can't be created outside of Submerged stage.": "无法在 Submerged 阶段之外创建。",
...
var cnPrefix = {
    ...
    "Make for: ": "成本：",
    "Puddles get boost based on Moles. (Equal to Moles ^ ": "水坑会根据 鼹鼠 得到提升。 （等于 鼹鼠 的 ^",
